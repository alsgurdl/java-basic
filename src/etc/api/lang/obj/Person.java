...
//tostring(); 객체의 정보(필드)를 문자열 형태로 리턴
    ...
    public boolean equals(Object o) {
        if (this == o) return true;//주소값이 같다면 같은 객체
        if (o instanceof Person){
            Person p = (Person) o;// 오브젝트 타입을 Person 타입으로 형 변환 name과age를 확인하기 위해
    ...
    @Override
    public int hashCode() {//주소값은 같게하는것
        return Objects.hash(name, age);
    }

    @Override
    protected void finalize() throws Throwable {
        //생성된 객체가 사라지는 시점에서 자동으로 호출
