...
import basic.datatype.Ineger;
import oop.modi.menber.pac1.B;
...
public class MainClass {
    public static void main(String[] args) {
        ...
        box.setObj(new String("길동"));
        int length = box.getObj().length(); //형변환이따로 필요 없다
        Box<Integer> intBox = new Box<>();
        intBox.setObj(20);
        Integer num = intBox.getObj();
        Box<Parson> pBox = new Box<>();
        pBox.setObj(new Parson());
